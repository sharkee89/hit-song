...
@triton.jit
def triton_batched_mel_kernel(
    spec_ptr, mel_filters_ptr, mel_out_ptr,
    num_bins: tl.constexpr, num_mels: tl.constexpr, num_frames,
    stride_spec_batch, stride_spec_bin, stride_spec_frame,
    stride_out_batch, stride_out_mel, stride_out_frame,
    BLOCK_SIZE_M: tl.constexpr, BLOCK_SIZE_N: tl.constexpr, BLOCK_SIZE_K: tl.constexpr,
):
    # Program ID po dimenzijama M, N i BATCH
    ...
    # Offset za spec pokaživač za konkretan BATCH
    ...
    for k_start in range(0, num_bins, BLOCK_SIZE_K):
        ...
        spec_ptrs = spec_batch_ptr + offs_k[:, None] * stride_spec_bin + offs_n[None, :] * stride_spec_frame
    ...
    out_ptrs = mel_out_ptr + pid_b * stride_out_batch + offs_m[:, None] * stride_out_mel + offs_n[None, :] * stride_out_frame
