...
def triton_chroma_kernel(
    ...
    stride_out_batch, stride_out_chr, stride_out_frame,
    ...
    out_ptrs = chroma_out_ptr + pid_b * stride_out_batch + offs_m[:, None] * stride_out_chr + offs_n[None, :] * stride_out_frame
